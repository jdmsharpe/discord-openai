...
`/openai chat` parameters (14 total): `prompt`, `persona`, `model`, `attachment`, `frequency_penalty`, `presence_penalty`, `temperature`, `top_p`, `reasoning_effort`, `verbosity`, `web_search`, `code_interpreter`, `file_search`, `shell`.
